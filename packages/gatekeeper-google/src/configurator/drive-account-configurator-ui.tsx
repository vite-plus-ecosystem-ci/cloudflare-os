...
import type {
  DriveAccountConfiguratorRpc,
  DriveAccountConfiguratorValues,
} from "./drive-account-configurator-types";
        ...
        >
          <RadioCards
            ...
            options={[
              {
                value: "account",
                title: "Everything this account can read in Drive",
                description:
                  "Includes direct lookup by file ID. Search results contain metadata only; native Google Docs and Sheets can be opened in read-only content sessions.",
              },
            ]}
