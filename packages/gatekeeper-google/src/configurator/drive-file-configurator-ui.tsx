...
import type {
  DriveFileConfiguratorRpc,
  DriveFileConfiguratorValues,
} from "./drive-file-configurator-types";
  ...
  render({ values, setValues, ui }) {
    return (
      <Section>
        <Field
          label="File"
          description="Search recent non-folder files. A selected native Google Doc or Sheet also provides read-only content."
        >
          <Autocomplete
            name="fileId"
            value={values.fileId}
