...
import type {
  CalendarConfiguratorRpc,
  CalendarConfiguratorValues,
} from "./calendar-configurator-types";
...
export default {
  ...
  isReady({ values }) {
    return (
      typeof values.calendarId === "string" &&
      values.calendarId.length > 0 &&
  ...
  resourceUrl({ values }) {
    ...
    const availabilityMode =
      values.availabilityMode === "allVisible" ? "allVisible" : "thisCalendar";
  ...
  render({ values, setValues, ui }) {
    ...
    return (
      <Section>
        <Field
          label="Calendar"
          description="Choose the calendar this connection can read and manage."
        >
          <Autocomplete
            name="calendarId"
          ...
          <RadioCards
            ...
            options={[
              ...
              },
              {
                ...
                description:
                  "Check anyone visible to your account. Collaborators must also be able to see their availability.",
              },
            ]}
            onChange={(nextMode) => {
