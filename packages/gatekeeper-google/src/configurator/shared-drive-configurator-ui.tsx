...
import type {
  SharedDriveConfiguratorRpc,
  SharedDriveConfiguratorValues,
} from "./shared-drive-configurator-types";
...
export default {
  ...
  render({ values, setValues, ui }) {
    return (
      <Section>
        <Field
          label="Google Workspace shared drive"
          description="Choose a shared drive owned by an organization rather than an individual. Search its files and read native Google Docs and Sheets."
        >
          <Autocomplete
            name="driveId"
