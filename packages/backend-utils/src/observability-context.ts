...
import { createLoggerWithContext, type LogValue, type ReservedLogField } from "./logger-core.js";
 ...
 */
export function createObservabilityContext<Fields extends { [Key in keyof Fields]: LogValue }>() {
  ...
  const withContext = <Result>(fields: Readonly<ContextFields<Fields>>, callback: () => Result) =>
