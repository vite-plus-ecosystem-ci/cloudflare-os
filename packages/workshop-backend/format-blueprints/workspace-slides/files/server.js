...
export class Gadget extends DurableObject {
  ...
  async addSlide(atIndex, slide) {
    ...
    const i =
      atIndex == null || atIndex < 0 || atIndex > d.slides.length ? d.slides.length : atIndex;
...
const GET_STARTED_SLIDE = {
  ...
  blocks: [
    { id: "b8216c3a", type: "sectionLabel", x: 36, y: 35, props: { text: "GET STARTED" } },
    {
      id: "b63fe9a1",
      type: "title",
      x: 35,
    ...
    { id: "165a8f0c", type: "logo", x: 1013, y: 40, props: { variant: "dark", scale: 0.62 } },
    {
      id: "a1725e4f",
      type: "svg",
      x: 50,
    ...
    },
    {
      ...
      w: 500,
      props: {
        text: "Click the pencil icon to add slides, insert components, edit content, and adjust the layout.",
        fontSize: 18,
        weight: 400,
        color: "#747474",
        family: "sans",
    ...
    },
    {
      ...
      h: 54,
      props: {
        markup: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 54"><rect x="1" y="1" width="52" height="52" rx="2" fill="#FFF8F2" stroke="#F3D8C5"/><g transform="translate(15 15)" fill="none" stroke="#F6821F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5L12 2z"/><path d="M20 15l.8 3.2L24 19l-3.2.8L20 23l-.8-3.2L16 19l3.2-.8L20 15z"/><path d="M4 14l.7 2.3L7 17l-2.3.7L4 20l-.7-2.3L1 17l2.3-.7L4 14z"/></g></svg>`,
        fit: "contain",
        background: "",
      },
    },
    ...
    },
    {
      ...
      w: 500,
      props: {
        text: "Ask the agent to create slides, add charts, connect approved internal data, or build your own components for a fully customized deck.",
        fontSize: 18,
        weight: 400,
        color: "#747474",
        family: "sans",
    ...
    },
    {
      ...
      w: 1128,
      props: {
        text: "Use either approach, or switch between them at any time.",
        fontSize: 18,
        weight: 600,
        color: "#000000",
        family: "sans",
    ...
    },
    {
      ...
      h: 12,
      props: {
        markup: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 12" preserveAspectRatio="none"><defs><linearGradient id="g"><stop stop-color="#FF6633"/><stop offset=".5" stop-color="#F6821F"/><stop offset="1" stop-color="#FBAD41"/></linearGradient></defs><rect width="1200" height="12" fill="url(#g)"/></svg>`,
        fit: "stretch",
        background: "",
      },
    },
...
const KEY_TAKEAWAYS_SLIDE = {
  ...
  background: { color: "#FFFFFF", inset: false, dotGrid: 0 },
  blocks: [
    { id: "e6fd515b", type: "sectionLabel", x: 36, y: 35, props: { text: "CONNECTED CHARTS" } },
    {
      id: "67fefcc4",
      type: "title",
      x: 35,
      ...
      w: 950,
      props: {
        text: "Turn internal data into presentation-ready charts",
        fontSize: 32,
        weight: 600,
        color: "#000000",
        letterSpacing: "-0.03em",
    ...
    { id: "16c8d805", type: "logo", x: 1013, y: 40, props: { variant: "dark", scale: 0.62 } },
    {
      id: "2b48e66e",
      type: "svg",
      x: 36,
  ...
  slides: [
    {
      ...
      blocks: [
        { id: "7d2196db", type: "logo", x: 36, y: 56, w: 267, props: {} },
        {
          ...
          w: 687,
          props: {
            text: "Compose your deck or build with agent.\n",
            fontSize: 58,
            weight: 700,
            color: "#FFFFFF",
            letterSpacing: "-0.03em",
        ...
        },
        {
          ...
          w: 553,
          props: {
            text: "Press E to edit. Add slides, drop in components, drag to move, then F to present.\n",
            fontSize: 17,
            weight: 600,
            color: "#FFFFFF",
            lineHeight: 1.5,
    ...
    },
    {
      ...
      background: { color: "#FFFFFF", inset: false, dotGrid: 0 },
      blocks: [
        { id: "a10324fe", type: "sectionLabel", x: 36, y: 35, props: { text: "SLIDE BUILDER" } },
        {
          id: "6457b707",
          type: "title",
          x: 35,
          ...
          w: 984,
          props: {
            text: "One canvas gives you everything you need to build and refine a deck",
            fontSize: 28,
            weight: 600,
            color: "#000000",
            letterSpacing: "-0.03em",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Start with title, narrative, two-column, or four-column layouts.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Add text, cards, media, shapes, and diagrams from one library.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Edit copy inline and tune every block in the inspector.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Drag, resize, reorder, and snap blocks to precise guides.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Keep connected editors in sync with shared undo and redo.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
        ...
        },
        {
          ...
          w: 320,
          props: {
            text: "Go full screen, jump between slides, and navigate by keyboard.",
            fontSize: 15,
            color: "#747474",
            weight: 400,
            family: "sans",
  ...
  return {
    slides: [
      // ----- Slide 1: cover ------------------------------------------------
      {
        ...
        blocks: [
          { id: genId(), type: "sectionLabel", x: 48, y: 38, props: { text: "Slide builder" } },
          { id: genId(), type: "logo", x: 1080, y: 38, props: {} },
          { id: genId(), type: "gadgetsMark", x: 48, y: 240, props: { size: "large" } },
          {
            id: genId(),
            type: "title",
            x: 48,
            ...
            w: 1040,
            props: {
              text: "Compose your deck from primitives.",
              fontSize: 46,
      ...
      // ----- Slide 2: cards in 4 tones ------------------------------------
      {
        ...
        blocks: [
          { id: genId(), type: "sectionLabel", x: 48, y: 38, props: { text: "Components" } },
          { id: genId(), type: "logo", x: 1080, y: 38, props: {} },
          {
            id: genId(),
            type: "title",
            ...
            y: 78,
            w: 1040,
            props: { text: "Cards come in tones.", fontSize: 42, highlight: "tones" },
          },
          {
            id: genId(),
            type: "subtitle",
            ...
            w: 1040,
            props: {
              text: "Each card carries a tone, an optional top stripe, an eyebrow, a title, and body copy.",
            },
          },
          {
            id: genId(),
            ...
            props: {
              ...
              eyebrow: "01",
              title: "Composable",
              body: "Every slide is just a list of blocks.",
            },
          },
          {
            id: genId(),
            ...
            props: {
              ...
              eyebrow: "02",
              title: "Themed",
              body: "Tones, fonts and spacing come from one set of tokens.",
            },
          },
          {
            id: genId(),
            ...
            props: {
              ...
              eyebrow: "03",
              title: "Live",
              body: "Edits sync across every connected viewer in real time.",
            },
          },
          {
            id: genId(),
            ...
            props: {
              ...
              eyebrow: "04",
              title: "Yours",
              body: "Add or remove slides, drag blocks anywhere on the canvas.",
            },
          },
        ],
      },
      // ----- Slide 3: diagram (boxes + arrows) ----------------------------
      {
        ...
        background: { inset: true },
        blocks: [
          { id: genId(), type: "sectionLabel", x: 48, y: 38, props: { text: "Diagrams" } },
          { id: genId(), type: "logo", x: 1080, y: 38, props: {} },
          {
            id: genId(),
            type: "title",
            ...
            w: 1040,
            props: {
              text: "Boxes and arrows, no Figma required.",
              fontSize: 40,
              highlight: "arrows",
            },
          },
          {
            ...
            w: 1040,
            props: {
              text: "Use the box and arrow blocks to sketch flows. Arrows take endpoints in slide coordinates.",
            },
          },
          {
            id: genId(),
            ...
            w: 220,
            h: 110,
            props: { tone: "neutral", title: "Source", body: "Where it starts" },
          },
          {
            id: genId(),
            type: "box",
            ...
            w: 220,
            h: 110,
            props: { tone: "blue", title: "Gatekeeper", body: "Where it’s checked" },
          },
          {
            id: genId(),
            type: "box",
            ...
            w: 220,
            h: 110,
            props: { tone: "orange", title: "Destination", body: "Where it lands" },
          },
          {
            id: genId(),
            type: "arrow",
            x: 0,
            y: 0,
            props: { x1: 316, y1: 395, x2: 490, y2: 395, color: "blue", label: "request" },
          },
          {
            id: genId(),
            type: "arrow",
            x: 0,
            y: 0,
            props: { x1: 710, y1: 395, x2: 884, y2: 395, color: "orange", label: "approved" },
          },
          {
            id: genId(),
            type: "tonePill",
