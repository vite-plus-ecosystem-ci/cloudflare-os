...
export function normalizeAdminConfig(p: Partial<AdminConfig>): AdminConfig {
  ...
  let signupsEnabled =
    typeof p.signupsEnabled === "boolean" ? p.signupsEnabled : DEFAULT_ADMIN_CONFIG.signupsEnabled;
  return {
    signupsEnabled,
    userSearchEnabled:
      typeof p.userSearchEnabled === "boolean" ? p.userSearchEnabled : !signupsEnabled,
