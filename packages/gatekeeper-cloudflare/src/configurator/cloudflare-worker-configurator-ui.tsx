...
export default {
  ...
  resourceUrl({ values }) {
    return (
      `https://dash.cloudflare.com/${encodeURIComponent(values.accountId!)}/workers/services/view/` +
      ...
      <Section>
        ...
        <Field label="Worker" description="Queries telemetry only for this Worker.">
          <Autocomplete
            ...
            loadOptions={(query) =>
              values.accountId ? ui.listWorkers(values.accountId, query) : Promise.resolve([])
            }
