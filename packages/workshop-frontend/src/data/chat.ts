...
export const sampleMessages: ChatMessage[] = [
  {
    ...
    role: "user",
    content:
      "Build a Slack channel summarizer that gives me a daily digest of unread channels using Workers AI",
    timestamp: "2:34 PM",
  },
  {
    id: "m2",
    role: "assistant",
    content:
      "I'll build a Slack channel summarizer for you. Let me start by setting up the project and connecting to your Slack workspace.",
    timestamp: "2:34 PM",
    toolCalls: [
      {
        id: "tc1",
  ...
  },
  {
    ...
    role: "assistant",
    content:
      "Great, I've got access to your Slack workspace. Let me fetch your channels and build the summarization API.",
    timestamp: "2:35 PM",
    toolCalls: [
      {
        id: "tc4",
        ...
        output:
          "Read 2 configured channels (847 + 1243 messages). Discovered 6 additional channels available.",
      },
      {
        id: "tc5",
        name: "write_file",
  ...
  },
  {
    ...
    role: "user",
    content:
      "Can you add a cron trigger that runs every morning at 9am and posts the digest to #general?",
    timestamp: "2:38 PM",
  },
  {
    id: "m7",
