...
describe("ComposerMirror geometry", () => {
  ...
  it("accepts image logo URLs and rejects unsafe CSS schemes", async () => {
    ...
    expect(container.querySelector<HTMLElement>("[data-token-start]")!.style.backgroundImage).toBe(
      "",
    );
    ...
    expect(
      container.querySelector<HTMLElement>("[data-token-start]")!.style.backgroundImage,
