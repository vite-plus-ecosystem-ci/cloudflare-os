          ...
          <div className="overflow-hidden rounded-2xl border border-kumo-line bg-kumo-elevated shadow-xl shadow-black/[0.04]">
            ...
            >
              ...
              <div className="min-h-[320px] w-full flex-shrink-0 p-5 sm:min-h-[420px] sm:p-8">
                <h2 className="text-lg font-medium text-kumo-default mb-1">Create your profile</h2>
              ...
              <div className="min-h-[320px] w-full flex-shrink-0 p-5 sm:min-h-[420px] sm:p-8">
                <div>
                  <h2 className="text-lg font-medium text-kumo-default mb-1">Choose your model</h2>
                      ...
                      <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
                        {models.map((model) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-kumo-subtle truncate">{model.id}</p>
                            </div>
                            {selectedModelId === model.id && (
                              <Check
                                size={18}
                        ...
                        {models.length === 0 && (
                          <div className="text-center py-8">
                            ...
                            <p className="text-xs text-kumo-inactive">Add a model to get started</p>
                          </div>
                        )}
                      </div>
              ...
              {/* ── Step 2: Connections ───────────────────────────────────────── */}
              <div
                className={`min-h-[320px] w-full flex-shrink-0 p-5 sm:min-h-[420px] sm:p-8 ${showConnectionsStep ? "" : "hidden"}`}
              >
                <div>
                  ...
                  <p className="text-sm text-kumo-subtle mb-6">
                    Link your accounts so your gadgets can access them. You can always add more
                    later.
                  </p>
                  ...
                  {vendorsLoading ? (
                    ...
                    <div className="text-center py-8">
                      <p className="text-sm text-kumo-subtle">No services available</p>
                    </div>
                  ) : (
                      ...
                      {sortedVendors.map((vendor) => {
                        ...
                        return (
                          <button
                            key={vendor.id}
                            onClick={() =>
                              !isConnected && !isConnecting && handleConnect(vendor.id)
                            }
...
const SHOWCASE_FEATURES: ShowcaseFeature[] = [
  ...
  },
  {
    ...
    description: "Share a workspace with teammates and work on it together, live.",
  },
  {
    icon: Key,
    ...
    description: "Plug in personal API tokens from any provider to use the models you love.",
  },
  {
    icon: Plugs,
  ...
  return (
    <div>
      <div className="text-center mb-6">
        <h2 className="text-lg font-medium text-kumo-default mb-1">You&apos;re all set</h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0 pt-0.5">
                <p className="text-sm font-medium text-kumo-default">{feature.title}</p>
